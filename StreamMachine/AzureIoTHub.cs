...
class AzureIoTHub
{
    ...
    //
    // Note: this connection string is specific to the device "ada". To configure other devices,
    ...
    //    iothub-explorer monitor-events --login HostName=neu.azure-devices.net;SharedAccessKeyName=service;SharedAccessKey=/ia6A053fAFpOnFw2nGjgKF4bv7wWof/j2xXJNmH0Mk= "ada"
    //
    ...
    public static async Task SendDeviceToCloudMessageAsync()
    {
        CreateClient();
#if WINDOWS_UWP
        var str = "{\"deviceId\":\"ada\",\"messageId\":1,\"text\":\"Hello, Cloud from a UWP C# app!\"}";
#else
        var str = "{\"deviceId\":\"ada\",\"messageId\":1,\"text\":\"Hello, Cloud from a C# app!\"}";
#endif
    ...
    {
        Debug.WriteLine("SampleMethod1 has been called");
    ...
    public static async Task RegisterDirectMethodsAsync()
    {
        ...
        Debug.WriteLine("Registering direct method callbacks");
